...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        for test_data in TEST_USERS:
            ...
            appuser.userdefault.likes = random.choice(FAKE_LIKES)
            appuser.userdefault.dislikes = random.choice(FAKE_DISLIKES)
            appuser.userdefault.allergies_or_sensitivities = random.choice(FAKE_ALLERGIES)
            appuser.userdefault.shipping_address = random.choice(FAKE_ADDRESSES)
            appuser.save()
